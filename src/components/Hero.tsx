...
const Hero = () => {
	return (
		<div className='grid grid-cols-1 lg:grid-cols-2 lg:items-center min-h-[calc(100dvh-_var(--h-header))] '>
			<div className='self-end lg:self-center pb-8 mt-[40%] mb-auto w-[150%] z-[1] '>
				...
				<Button extraClassName='my-8'>Contact me!!</Button>
			</div>
			<div className='relative flex flex-col justify-end min-h-[40vh] mb-[30%] mt-auto'>
				<Image
					src={logoOutline}
					alt='Logo outline'
				...
				<Image
					src={dottedBox}
					alt='Dotted box'
					className='absolute bottom-[10rem] right-[4rem]  w-[8rem] '
				/>
